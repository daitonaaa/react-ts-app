  ...
  return {
    ...
    resolve: {
      ...
      alias: {
        ...
        converters: path.resolve(rootFolder, 'src/converters'),
        models: path.resolve(rootFolder, 'src/models'),
        hooks: path.resolve(rootFolder, 'src/hooks'),
        builders: path.resolve(rootFolder, 'src/builders'),
        styles: path.resolve(rootFolder, 'src/styles'),

        types: path.resolve(rootFolder, 'src/types'),
